        ...
        <div class="container mx-auto">
            ...
            <div class="flex">
                <button onclick="moveSlide(-1)">
                    <svg class="border rounded-full bg-slate-300 h-9" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
